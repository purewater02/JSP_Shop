...
<script type="text/javascript">
	function check(no) {
		...
		if(res) {
			...
			location.href="admin_review_delete.do?no="+no;/* "&pwd="+pwd; */
		}
	}
</script>
</head>
<body>
	...
	<div align="center">
		...
		<table border="1" cellspacing="0" width="500">
			<tr bgcolor="#eeffee">
				<th>글 번호</th> <th>글 제목</th> <th>작성자</th> <th>작성일</th> <th>삭제</th>
			</tr>
			...
			<c:if test="${!empty list }">
				<c:forEach items="${list }" var="dto">
					<tr>
						<td>${dto.getbNo() }</td>
						<td><a href="admin_review_detail.do?no=${dto.getbNo()}&page=${paging.getPage()}">${dto.getbTitle() }</a></td>
	...
	<c:url var="loadList" value="/admin_review_list.do" />
