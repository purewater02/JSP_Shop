...
<form name="newMem" method="post" action="user_order_ok.do">     <!--  폼의 이름이 form으로 지정됨 -->
	<input type="hidden" name="sessionId" value="${loggedId}">
	<input type="hidden" name="cartNo" value="${cartNoQS}">
...
<table class="table_cont_style">
	...
	<tr>
		...
		<td width=470>&nbsp;&nbsp;&nbsp;<input type="text" name="zipcode" size="7" readonly> 
			       &nbsp;&nbsp;&nbsp;<input class="normal_btn" type="button" value="우편번호검색" onClick="zipCheck_order()"><br>     
...
<table class="table_cont_style">
	<tr>
		...
		<input class="normal_btn" type="button" onclick="useMileage(${totalAll}, <%=availMileage %>)" value="마일리지 사용">
...
<div class="btn_container">	     
	<input class="submit_btn" type="submit" value="주문확인" onclick="confirm('정말로 주문하시겠습니까?')"> 
	<input class="cancel_btn" type="button" value="주문취소" OnClick="history.back()">	
</div>                 
